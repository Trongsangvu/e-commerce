    ...
    <footer className="mt-auto">
      <div className="bg-[#222222] px-[164px] pt-[75px] pb-[32px]">
        <div className="grid grid-cols-4 gap-10">
          <div>
            <h4 className="text-[#fff] text-[15px] leading-[1.6] uppercase pb-[30px] font-[Montserrat-Bold]">
              categories
            </h4>
            <ul>
              <li className="pb-10">
          ...
          <div>
            ...
            <form action="">
              ...
              <div className="pt-18">
                <button className="cursor-pointer uppercase transition-all duration-500 hover:bg-[#fff] hover:text-[#6774d5] bg-[#6774d5] font-[Poppins-medium] rounded-3xl h-[46px] min-w-[179px] text-[#fff]">
                  subcribe
                </button>
              </div>
            </form>
