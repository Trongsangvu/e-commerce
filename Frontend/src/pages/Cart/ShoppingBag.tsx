...
const ShoppingBagComponent: React.FC<Props> = ({
    ...
    return (
      ...
      >
        <div role="alert" className="flex gap-20">
          ...
          <div>
            <span className="font-[GucciSansPro-light] text-[13px] text-[black]">
  ...
  return (
    <div className="relative">
      <div
        className={`absolute left-[120px] w-[488px] h-[550px] bg-white
            `}
      >
        <div className="flex border-b-1 border-[#ccc] px-30 items-center">
          <h2 className="uppercase font-[GucciSansPro-bold] text-[#000] tracking-[-0.03rem] py-20 w-[400px] text-center">
              ...
              return (
                <li className="flex mb-20" key={index}>
                  ...
                  <div className="ml-15">
                    ...
                    <div className="font-[GucciSansPro-light] tracking-[-0.03rem] text-[13px] text-[#000] mt-20">
        ...
        <div className="my-16 mx-24">
          <div className="flex justify-center items-center w-[440px] h-[48px] bg-[#000] rounded-[2px] cursor-pointer">
            <button
              className="cursor-pointer uppercase font-[GucciSansPro-bold] text-[#fff] tracking-[-0.03rem] text-[12px]"
          ...
          <div className="flex justify-center items-center w-[440px] h-[48px] bg-[#fff] rounded-[2px] cursor-pointer mt-15 border-1">
            <button
              className="cursor-pointer uppercase font-[GucciSansPro-bold] text-[#000] tracking-[-0.03rem] text-[12px]"
