      ...
      <div className="pb-[85px]">
        ...
        <div className="flex items-center justify-start max-w-[680px] mt-[30px] mb-[20px]">
          <Link to={config.routes.home}>
            <span className="pl-[150px] font-[Poppins-regular] text-sm text-[#555]">
              Home
            </span>
          </Link>
          <span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-[2fr_1fr]">
          <div className="pl-[150px]">
            <table className="min-w-[680px]">
              <thead className="border border-[#ccc]">
                <tr>
                  <th className="py-15 pl-[50px] font-[Poppins-bold] text-start uppercase text-sm text-[#555]">
                    product
                  </th>
                  ...
                  <th className="py-15 pl-[50px] pr-[50px] text-center font-[Poppins-bold] uppercase text-sm text-[#555]">
                    total
                  </th>
                </tr>
              </thead>
              <tbody>
                {cartItems.map((cart: ICartItem, index: number) => {
                  ...
                  const quantity =
                    updatedQuantity[index]?.quantity || cart.quantity || 0;
                  ...
                  return (
                    <tr className="border border-[#ccc] h-[185px]" key={index}>
                      ...
                      <td className="font-[Poppins-regular] text-[#555] pl-10 w-[222px]">
                        {cart.productId.name}
                      </td>
                      <td className="font-[Poppins-regular] text-[#555] w-[145px]">
                      ...
                      <td className="font-[Poppins-regular] text-center text-[#555] w-[172px]">
                        ${total}
                      </td>
                    </tr>
                  );
          ...
          <div className="border border-[#e6e6e6] mr-[40px] w-[470px] h-[620px]">
            <div className="px-[40px] py-[30px] h-auto">
              <h3 className="uppercase font-[Poppins-bold] pb-[30px]">
                cart totals
              </h3>
              <div>
                ...
                <div className="text-center mt-20">
                  <button className="text-white cursor-pointer bg-[#222] rounded-[22px] py-15 px-[30px] uppercase">
                    proceed to checkout
                  </button>
                </div>
              </div>
