    ...
    <div>
      <div className="mb-90">
        ...
        <div className="flex justify-center">
          <div className="max-w-1200 pt-106">
            <div className="grid grid-cols-2">
              <form
                onSubmit={handleSendEmail}
                className="border border-[#e6e6e6] px-50 pt-50"
              >
                <h3 className="font-[Poppins-regular] text-[#333] text-center mb-30">
                  Send Us A Message
                </h3>
                ...
                <div className="border border-[#e6e6e6] px-20 pt-25 mb-20">
                  <textarea
                    className="outline-none w-full min-h-199 font-[Poppins-regular]"
                    name="msg"
